...
SELECT
  ...
  CAST(drug_type_of_measurement AS STRING) AS drug_type,
  ...
  CAST(mrf_url AS STRING) AS mrf_url,
  CAST(source_page_url AS STRING) AS source_page_url,
...
SELECT
  ...
  CAST('JSON' AS STRING) AS source_format,

  CAST(NULL AS INT64) AS source_row_number,

  CAST(source_service_number AS INT64) AS source_service_number,
  CAST(source_charge_number AS INT64) AS source_charge_number,
  CAST(source_payer_number AS INT64) AS source_payer_number,
  ...
  CAST(mrf_as_of_date AS STRING) AS mrf_as_of_date,
